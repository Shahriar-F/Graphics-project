...
void startscreen(void)
{
    ...
    drawstring(380,530,0.0,"PROJECT ON:");
    drawstring(300,500,0.0,"AIUB PERMANENT CAMPUS");
    glColor3f(1,0.5,0);
    drawstring(75,400,0.0,"SUBMITTED BY:(Group-I)");
    glColor3f(1,1,1);
    drawstring(75,370,0.0,"(1) Natasha, Sabiha Hazera (19-39671-1) ");
    drawstring(75,290,0.0,"(2) Fahim, Shahriar Alam   (19-39697-1) ");
    drawstring(75,210,0.0,"(3) Lasker, Abdul Haider   (19-39699-1) ");
    drawstring(75,130,0.0,"(4) Islam, Tasmia          (19-40582-1) ");
    glColor3f(1,0.5,0);
    drawstring(750,200,0.0,"SUBMITTED TO:");
    glColor3f(1,1,1);
    drawstring(700,150,0.0," DIPTA JUSTIN GOMES");
    glColor3f(0,0,1);
    drawstring(350,80,0.0,"PRESS ENTER TO START");
    glFlush();
}
void controlsScreen()
{
    ...
    glColor3f(1.000, 0.980, 0.941);
    drawstring(600.0,480.0,0.0,"PRESS 'S'");
    glColor3f(1.000, 0.980, 0.941);
